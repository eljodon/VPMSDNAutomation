...
if ($oauth.access_token -ne $null)
{
    ...
    [xml]$autoScaleSettings = Set-AzureAutoScale -subscriptionName $subscriptionName -cloudServiceName $cloudServiceName -availabilitySetName $availabilitySetName -oauth $oauth -Verbose
